...
// Constructeur
tetromino_i::tetromino_i(int x, int y, QColor couleur,int type, int orientation) : tetromino(x, y, couleur, type, orientation)
{
    m_x = x;
    m_y = y;
    m_couleur = couleur;
    ...
    m_tabTetromino[1][3][2] = 1;

    // orientation 2
    m_tabTetromino[2][2][0] = 1;
